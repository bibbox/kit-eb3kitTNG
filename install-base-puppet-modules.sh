...
/opt/puppetlabs/bin/puppet module install --force puppetlabs-stdlib --version 7.5.0  --modulepath /etc/puppetlabs/code/modules
...
/opt/puppetlabs/bin/puppet module install --force puppetlabs-docker_platform --version 2.1.0 --modulepath /etc/puppetlabs/code/modules
